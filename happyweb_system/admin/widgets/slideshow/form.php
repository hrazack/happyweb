      ...
      foreach($files as $index => $obj) {
        ...
        <li class="dd-item" data-id="<?php print $obj->id; ?>">
          ...
          <div class="dd-content">
            <div class="cell image"><img src="/my_website/uploaded_files/originals/<?php print $filename; ?>" width="100" /></div>
...
$(document).ready(function() {
  ...
  $('#file-upload').change(function(e) {
    ...
    $.ajax({
      url: '/happyweb_system/admin/widgets/slideshow/upload.php',
      ...
      success: function(data) {
        if (data.status != "error") {
          ...
          $.each(data.files, function(key, filename) {
            ...
            str += '<div class="cell image"><img src="/my_website/uploaded_files/originals/'+filename+'" width="100" /></div>';
