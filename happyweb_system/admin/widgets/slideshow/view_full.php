...
if ($data->disable_slideshow == 0) {
  ...
  add_js('<script type="text/javascript" src="/happyweb_system/admin/widgets/slideshow/slideshow.js"></script>');
}
?>
...
if ($data->filenames != "") {
  foreach($files as $obj) {
    ...
    print '<img src="/my_website/uploaded_files/large/'.$filename.'" />';
...
<?php
foreach($files as $obj) {
  print '<div><img src="/my_website/uploaded_files/large/'.$obj->id.'" /></div>';
}
?>
</div>
*/
