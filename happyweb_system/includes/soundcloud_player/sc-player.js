...
(function($) {
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $container = $('<div class="sc-container">').appendTo($player),
        $info = $('<div class="sc-info"><h3></h3><h4></h4><p></p></div>').appendTo($container),
        ...
        $playback = $('<div class="sc-playback">').appendTo($container);
        $controls = $('<div class="sc-controls"></div>').appendTo($playback);
        $playback
          .find('.sc-controls')
