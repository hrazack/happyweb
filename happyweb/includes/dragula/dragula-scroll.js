...
function dragula (initialContainers, options) {
  ...
  function drag (e) {
    ...
    // this is added in order for the page to scroll when dragging an element
    document.addEventListener('mousemove', function(e) {
      if (e.which === 1) { // if click down
        ...
        if (mousePosition <= 0 || mousePosition >= h) { // if we are at the top or bottom of the screen
          var shift = (mousePosition > 0)?1:-1;
