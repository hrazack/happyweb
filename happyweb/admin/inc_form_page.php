...
<div id="widget-list">
  <ul class="widget-list">
    ...
    <li><a data-widget-type="navigation" data-require-form="false" class="navigation tooltip" title="This will list the pages that are under this page"><i class="material-icons bigger">featured_play_list</i>Side nav</a></li>
    <li><a data-widget-type="thumbnail" data-require-form="true" class="thumbnail tooltip" title="This will add a small image with some heading, text and a link. It can be used for a list of team members or a list of latest news"><i class="material-icons bigger">picture_in_picture</i>Image link</a></li>
  </ul>
</div>