...
if (isset($_POST["action"])) {
  ...
  $sql_filename = "happyweb/includes/happyweb.sql";
  $templine = '';
  ...
  // copy the basic theme to "your_site/themes/site_name
  $site_name = $db->escape($_POST["site_name"]);
  $new_theme = sanitize_string($site_name);
  copy_folder("happyweb/themes/basic", "your_site/themes/".$new_theme);
